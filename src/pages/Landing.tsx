      ...
      <div className="relative z-10">
        ...
        <nav className="px-6 md:px-12 py-6 flex items-center justify-between max-w-7xl mx-auto">
          ...
          <Button 
            ...
            className="text-white text-base font-semibold hover:text-[#01B8AA] hover:bg-[#01B8AA]/10 border border-slate-700 hover:border-[#01B8AA]/50 transition-all px-5 py-2"
        ...
        <section className="px-6 md:px-12 py-16 md:py-24 max-w-7xl mx-auto text-center">
          ...
          {/* Headline */}
          <h1 
            className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black tracking-tight mb-6 text-[#01B8AA]"
